...
sampler Nametag_Sampler_0 = sampler_state
{
	Texture = (Detail_0);
	AddressU = CLAMP;
	AddressV = CLAMP;
...
sampler Nametag_Sampler_1 = sampler_state
{
	Texture = (Detail_1);
	AddressU = CLAMP;
	AddressV = CLAMP;
...
{
	float4 Tx0 = tex2D(Nametag_Sampler_0, Input.TexCoord0);
...
{
	float4 Tx0 = tex2D(Nametag_Sampler_0, Input.TexCoord0);
	float4 Tx1 = tex2D(Nametag_Sampler_1, Input.TexCoord1);
