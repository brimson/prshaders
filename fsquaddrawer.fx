...
{
    VS2PS_blit outdata;
    outdata.Pos = mul(float4(indata.Pos.xy, 0.0, 1.0), customMtx);
    outdata.TexCoord0 = indata.TexCoord0;
    return outdata;
}
...
VS2PS_5SampleFilter vsDx9_5SampleFilter(
    APP2VS_blit indata,
...
float4 psDx9_FSBMGlowFilter(
    VS2PS_5SampleFilter indata,
...
{
    return tex2D(sampler0point, indata.TexCoord0); // close
}
