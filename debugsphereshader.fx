...
>
{
    pass p0
    {
        ...
        PixelShader = compile ps_2_a PShader(samplebase);
    }
}
...
>
{
    pass p0
    {
        ...
        VertexShader = compile vs_2_a vsLightSource(mWorldViewProj, MaterialDiffuse);
        PixelShader = compile ps_2_a psLightSource();
    }
    pass p1
    {
